...
/// <remarks>This service can be used to initialize the culture settings (must be done before the first view is created) or to register resource dictionaries.</remarks>
