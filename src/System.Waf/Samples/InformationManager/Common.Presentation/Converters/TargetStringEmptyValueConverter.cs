...
{
    /// <summary>
    /// Value converter that returns a special string if the (string) value is null or empty.
    /// </summary>
    public class TargetStringEmptyValueConverter : IValueConverter
    {
        /// <summary>
        /// Returns a special string if the (string) value is null or empty. Otherwise it returns value.
        /// </summary>
        ...
        {
            return string.IsNullOrEmpty(value as string) ? "(none)" : value;
        }
