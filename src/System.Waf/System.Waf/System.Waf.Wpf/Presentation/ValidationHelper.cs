...
namespace System.Waf.Presentation
{
    ...
    {
        /// <summary>Identifies the IsEnabled attached property. This property contains the value that indicates whether the ValidationHelper is enabled.</summary>
        ...
        /// <summary>Identifies the IsValid attached property. This property contains the value that indicates whether the associated object is valid.</summary>
        /// <remarks>This is a readonly property. However, it is allowed to define a Binding with the Mode=OneWayToSource for this property.</remarks>
        ...
        /// <summary>Sets the value that indicates whether the ValidationHelper is enabled. The default value is 'false'. It is not allowed to call this method with 'false'.</summary>
