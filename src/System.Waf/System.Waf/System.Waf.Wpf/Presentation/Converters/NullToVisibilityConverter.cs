...
{
    /// <summary>Value converter that uses the is Null condition to return the associated Visibility enumeration value.</summary>
    public sealed class NullToVisibilityConverter : IValueConverter
    {
        ...
        /// <summary>Returns a Visibility enumeration value depending on the is Null condition of the specified value.</summary>
