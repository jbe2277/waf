...
namespace Test.Waf.Foundation
{
    ...
    public class WeakHelperEventHandlerTTest
    {
        ...
        {
            public IWeakEventProxy Register(Publisher publisher, Subscriber subscriber) => WeakHelper.EventHandler<PropertyChangedEventArgs>.Register(publisher, subscriber.Handler, (s, h) => s.Event1 += h, (s, h) => s.Event1 -= h);
        }
