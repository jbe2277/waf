...
{
    /// <summary>This mock class implements the IFileDialogService interface.</summary>
    [Export(typeof(IFileDialogService)), Export]
    public class MockFileDialogService : IFileDialogService
    {
        /// <summary>The file dialog result of the last dialog.</summary>
        public FileDialogResult? Result { get; set; }

        /// <summary>The owner window of the last dialog.</summary>
        public object? Owner { get; private set; }

        /// <summary>The file dialog type of the last dialog.</summary>
        public FileDialogType FileDialogType { get; private set; }

        /// <summary>The supported file types of the last dialog.</summary>
        public IEnumerable<FileType> FileTypes { get; private set; } = Array.Empty<FileType>();

        /// <summary>The default file type of the last dialog.</summary>
