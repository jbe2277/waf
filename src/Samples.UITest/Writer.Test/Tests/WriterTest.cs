...
public class WriterTest : UITest
{
    ...
    public void MultipleNewSaveRestartOpenRecentChangeAskToSave() => Run(() =>
    {
        ...
        using (Launch(resetSettings: false))
        {
            ...
            var tab2 = window.DocumentTab.SelectedTabItem.As<DocumentTabItem>();
        ...
        using (Launch(resetSettings: false))
        {
            ...
            var tab1 = window.DocumentTab.SelectedTabItem.As<DocumentTabItem>();
